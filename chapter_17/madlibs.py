...
def mad_libs(mls):
    """
    Docstring for mad_libs
    
    :param mls: String
    with parts the user should fill out surrounded by double underscores. underscores cannot be inside hint e.g., no __hint_hint__ only __hint__.
    """
